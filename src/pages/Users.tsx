...
import { useUserListStore } from "@/stores/userStore";
  ...
  const handleDialogSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data = Array.isArray(usersRes.data)
        ...
        : usersRes.data.users || usersRes.data.results || [];
      setUsers(data);
      setSuccess(dialogMode === "add" ? "User created successfully!" : "User updated successfully!");
      setDialogOpen(false);
      setForm(initialState);
      setProfileImageFile(null);
      setSelectedUser(null);
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent className="max-w-lg w-full p-8 rounded-lg shadow-lg bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                <DialogTitle className="mb-4 text-2xl font-bold text-center text-black dark:text-white">
                  {dialogMode === "add" ? "Create User" : "Edit User"}
                </DialogTitle>
                <form onSubmit={handleDialogSubmit} className="space-y-4">
                  ...
                  <div className="flex gap-4 mt-6 justify-center">
                    <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition font-semibold">
